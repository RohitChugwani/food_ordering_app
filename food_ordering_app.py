    ...
    def edit_food_info(self):
        ...
        if x not in food_info:
            ...
            if y==1:
                ...
                return
print("please enter 1 if you are a user and 2 if you are an admin")
x=int(input())
if x==1:
    u=user()
    print("Are you already registered ,if yes then enter 1 to directly login or 2 to register if you are new here")
    a=int(input())
    if a==1:
        u.login_user()
    elif a==2:
